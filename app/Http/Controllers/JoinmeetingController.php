...
class JoinmeetingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('joinmeetings.index',compact('groupusers','meetings'))->with('i', (request()->input('page', 1) - 1) * 5);  
    }
    ...
    {
        $meetings = Meeting::where('hidden', '0')->get();
        return view('joinmeetings.create', compact('meetings'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$user) {
            ...
            if (!$user1) {
                ...
                return redirect()->route('joinmeetings.index')->with('success','Group Changed successfully.');
            }
            else {
        ...
        return redirect()->route('joinmeetings.index')
    ...
    public function leave(Groupuser $groupuser)
    {
        ...
        if(!$cuser) {
            ...
            return redirect()->route('meetings.index')->with('success','Group left successfully');
        }
        else {
